...
public class DriverContextWeb {
	 ...
	 * @return 
	 */
	public static String WaitUntilElementClicked(final By elementFindBy) {
		WebDriverWait wait = new WebDriverWait(DriverContextWeb.Driver, 30);
		String text = wait.until(ExpectedConditions.elementToBeClickable(elementFindBy)).getText();
