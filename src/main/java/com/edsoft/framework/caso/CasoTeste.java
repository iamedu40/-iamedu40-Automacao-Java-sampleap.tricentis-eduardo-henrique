package com.edsoft.framework.caso;

public class CasoTeste {
	/**
	 * Class de atributos de caso de teste
	 */
	...
	public String getNomeArquivoEvidencia() {
		return this.nomeArquivoEvidencia;
	}
